...
function loadInstrContent() {
    var instrContent = [
        ...
        /* ind1 */ `<p>In this experiment, you will see an image of people interacting in groups flash on your screen for a <b>short</b> amount of time.</p><p>You should take in as much information as you can during this time!</p><p>Your task is to try to <i>reproduce the amount of time</i> the image was displayed on screen by holding down a button.</div>`,
        /* ind2 */ `<p>To make sure you're focused on the whole scene, you might be asked during the experiment to <i>correctly identify a detail</i> about the people you just saw.</p><p>Try to pay <b>close</b> attention!</p>`,
