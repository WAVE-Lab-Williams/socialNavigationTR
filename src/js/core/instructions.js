...
function loadInstrContent() {
    var instrContent = [
        ...
        /* ind1 */ `<p>In this experiment, you will see a complex image with people flash on your screen for a <b>short</b> amount of time.</p><p>You should take in as much information as you can during this time!</p><p>Your task is to try to <i>reproduce the amount of time</i> the image was displayed on screen by holding down a button.</div>`,
        /* ind2 */ `<p>Remember, your task is to reproduce how long this image was on screen. Once in a while, however, you will <i>additionally</i> be asked whether or not the color <b>red</b> was in the image or not.</p><p>Be sure to pay <b>close</b> attention!</p>`,
