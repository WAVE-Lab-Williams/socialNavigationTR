...
function loadInstrContent() {
    var instrContent = [
        ...
        /* ind1 */ `<p>In this brief experiment, you will see a complex image with people flash on your screen for a <b>short</b> amount of time.</p><p>You should take in as much information as you can during this time!</p><p>Your task is to try to <i>reproduce the amount of time</i> the image was displayed on screen by holding down a button.</div>`,
        /* ind2 */ `<p>Remember, your task is to reproduce how long this image was on screen. Once in a while, however, you will <i>additionally</i> be asked whether or not <b>the color red</b> was in the image or not.</p><p>Be sure to pay <b>close</b> attention!</p>`,
        /* ind3 */ `<p>Sometimes, you may be unsure of how long to hold down the button. This is okay, since the task is designed to be tricky! In times like this, just give it your <b>best guess</b>, as we are interested in your <i>gut intuition</i>.</p><p>Please do your very best to remain as focused and attentive as possible, even at the end of the experiment. We know it is very difficult to stay focused for so long, especially when you are doing the same thing over and over. But remember, the experiment will be all over in less than ${String(estTotalRunTime)} minutes. Press the button below to begin. Get Ready!`,
    ];
